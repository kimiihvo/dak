...
<body>
		...
		<div class="content-wrap">
			<div class="content">
                <div class="content-main">
                    <h3 class="hide">후기내역검색폼</h3>
                    <form role="form" class="">
                        <fieldset>
                            <legend class="hide">후기검색</legend>
                            <div class="form-group">
                                <select name="" id="">
                                    <option value="">닉네임</option>
                                </select>
                                <label class="hide">검색어</label>
                            ...
                            <c:choose>
	                            ...
	                            <c:otherwise>
	                                <c:forEach var="item" items="${output}" varStatus="st">
	                                    ...
	                                    <tr>
	                                        <td align="center">${item.reviewno}</td>
	                                        ...
	                                        <td align="center">${item.memRating}</td>
	                                        <td align="center"><a href="${pageContext.request.contextPath}/admin/review_view.do?reviewno=${item.reviewno}"><button type="button" class="btn btn-primary btn-block">선택</button></a></td>
	                                    </tr>
	                                </c:forEach>
	                            </c:otherwise>
	                        </c:choose>
    ...
    <c:choose>
        ...
        <c:when test="${pageData.prevPage > 0}">
            <%-- 이동할 URL 생성 --%>
            <c:url value="/admin/review_list.do" var="prevPageUrl">
    ...
    <c:forEach var="i" begin="${pageData.startPage}" end="${pageData.endPage}" varStatus="status">
        <%-- 이동할 URL 생성 --%>
        <c:url value="/admin/review_list.do" var="pageUrl">
    ...
    <c:choose>
        ...
        <c:when test="${pageData.nextPage > 0}">
            <%-- 이동할 URL 생성 --%>
            <c:url value="/admin/review_list.do" var="nextPageUrl">
