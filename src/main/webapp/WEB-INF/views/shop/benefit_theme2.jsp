	    ...
	    <main>
	        ...
	        <div class="theme-box">
	            <div class="theme-select">
	                <select>
	                    <option value="1">진-짜 잘나가는건 나야, 둘이 될 순 없어</option>
	                    <option value="2" selected>추운 겨울, 따뜻함이 생각날 때</option>
	                </select>
	        ...
	        <section>
	            <article class="theme-art">
	                <img src="${pageContext.request.contextPath}/assets/img/theme1.jpg" alt=""/>
	                <h2>
	                   	 테마 추천 상품
	                </h2>
	                <ul class="product-theme">
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist1.jpg">
	                                </div>
	                                <div class="desc">
	                    ...
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist2.jpg">
	                                </div>
	                                <div class="desc">
	                                    <p class="name">맛있닭 닭가슴살 한끼 순대</p>
	                                    <div class="price-deli">
	                    ...
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist3.jpg">
	                                </div>
	                                <div class="desc">
	                                    <p class="name">맛있닭 닭가슴살 한끼 순대</p>
	                                    <div class="price-deli">
	                    ...
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist4.jpg">
	                                </div>
	                                <div class="desc">
	                                    <p class="name">맛있닭 닭가슴살 한끼 순대</p>
	                                    <div class="price-deli">
	                    ...
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist5.jpg">
	                                </div>
	                                <div class="desc">
	                                    <p class="name">맛있닭 닭가슴살 한끼 순대</p>
	                                    <div class="price-deli">
	                    ...
	                    <li>
	                        <a href="detail.html">
	                            <div class="box clear">
	                                <div class="img">
	                                    <img src="${pageContext.request.contextPath}/assets/img/themelist6.jpg">
	                                </div>
	                                <div class="desc">
	                                    <p class="name">맛있닭 닭가슴살 한끼 순대</p>
	                                    <div class="price-deli">
    ...
    <script type="text/javascript">
        $(function() {
           ...
           $(".theme-select > select").change(function(){
                ...
                if (theme == 1){
                $(location).attr('href','benefit_theme.html');
               
                }
                else{
                $(location).attr('href','benefit_theme2.html');
